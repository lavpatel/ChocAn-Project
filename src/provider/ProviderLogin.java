...
public class ProviderLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Provider provider = (Provider) session.get(Provider.class, Long.parseLong(id.getText()));
        session.getTransaction().commit();
        session.close();
        
        if(provider.getPassword().equals(password.getText())){        
            UserCardSwipe ucs = new UserCardSwipe(provider);
            ucs.setVisible(true);
            setVisible(false);
        }else{
